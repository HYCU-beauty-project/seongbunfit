...
export default function ProductsContent({ compact = false }: Props) {
  ...
  return (
    <>
      <div className={`flex flex-wrap items-start justify-between gap-4 ${compact ? "flex-col" : ""}`}>
        <div>
          <h1 className={compact ? "text-[18px] font-bold text-[var(--color-ink)]" : "text-[22px] font-bold text-[var(--color-ink)]"}>
            화장품 검색
          </h1>
