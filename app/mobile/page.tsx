          ...
          <div className="flex flex-col items-center text-center gap-4">
            ...
            >
              ...
              <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-[var(--color-primary-soft)] transition-transform active:scale-95">
                <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--color-primary)]">
            ...
            <div>
              ...
              <p className="mt-2 text-[12px] text-[var(--color-ink-soft)] leading-relaxed">
                촬영 환경에 따라 결과가 달라질 수 있어 참고용으로만 활용해주세요.
                모바일에서는 카메라 권한이 필요해요.
              </p>
              <Link
                href="/mobile/face-analysis"
              ...
              <div className="rounded-2xl bg-white p-5 shadow-sm">
                ...
                <ul className="mt-2 space-y-1.5">
                  {phase.items.map((item) => (
                    <li key={item} className="flex items-start gap-1.5 text-[11.5px] text-[var(--color-ink-soft)]">
