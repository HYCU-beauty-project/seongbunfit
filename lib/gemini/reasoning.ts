...
/**
 * 계산된 점수를 근거로 AI가 자연스러운 추천 이유 문장 생성.
 * GEMINI_API_KEY 없거나 호출 실패하면 lib/scoring/calculator.ts 템플릿 문장으로 폴백
 * (숫자 계산은 AI가 안 함. scoreProducts()가 이미 계산해둔 값의 "설명"만 맡김.
 * 그래야 AI가 점수 지어내는 일 없이 진짜 계산된 데이터 기반 설명이 나옴)
 */
